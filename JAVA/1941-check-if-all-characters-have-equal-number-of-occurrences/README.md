...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/check-if-all-characters-have-equal-number-of-occurrences/)
...
**My Solution:** [1941-Check-if-All-Characters-Have-Equal-Number-of-Occurrences.java](./1941-Check-if-All-Characters-Have-Equal-Number-of-Occurrences.java)
