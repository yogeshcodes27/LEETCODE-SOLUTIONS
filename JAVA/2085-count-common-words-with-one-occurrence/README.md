...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/count-common-words-with-one-occurrence/)
...
**My Solution:** [2085-Count-Common-Words-With-One-Occurrence.java](./2085-Count-Common-Words-With-One-Occurrence.java)
